package com.smmall.controller.index;
...
import com.smmall.mapper.ResourcesMapper;
import com.smmall.mapper.RoleMapper;
import com.smmall.mapper.UserLoginMapper;
import com.smmall.util.Common;
import com.smmall.util.TreeObject;
import com.smmall.util.TreeUtil;
...
public class BackgroundController extends BaseController {
	 ...
	 * 获取某个用户的权限资源
	 * 
	 * @author liuyaliu Email：mmm333zzz520@163.com date：2014-3-4
	 * @param request
	 * @return
	 */
